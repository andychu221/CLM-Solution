Insurance Contract & Claim Management System by Gemini 2.5 pro
...
Features
Interactive Dashboard: At-a-glance view of key metrics including active policies, total coverage, total premium, and year-to-date (YTD) claim statistics.

Dynamic Charts: Visualize data with multiple chart types:
...
Comprehensive Policy Management: Create, edit, and view insurance policies. Includes support for complex policy details and type-specific fields.

Claims Management: Submit and manage claims with detailed information like loss location, incident descriptions, and payment status.

Approval Workflow: A built-in approval system for new policies and claims, ensuring proper oversight. Items requiring approval are clearly displayed on the dashboard.

Co-insurance Support: Easily manage policies with multiple insurers and define their respective coverage ratios.

User Simulation: Switch between different user roles (e.g., HQ Admin, Regional Manager) to see a permission-based view of the data.

Multi-language Support: The interface supports English, Traditional Chinese (繁體中文), and Japanese (日本語).

Audit Logging: Tracks all major actions within the system, such as creation, edits, and approvals, providing a clear audit trail.
